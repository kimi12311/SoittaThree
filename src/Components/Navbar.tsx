  ...
  return (
    <div className="flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4">
      ...
      <ul className="hidden md:flex md:uppercase">
        ...
        <li className="p-4"><Link to="/about" onClick={() => handleScroll("about")} className="hover:text-sky-100 transition-all">About</Link></li>
      </ul>
      ...
      <div className={open ? "fixed left-0 top-0 w-[60%] h-full bg-[#070707] ease-in-out duration-300 transition-all" : "fixed left-[-75%]"}>
        ...
        <ul className="pt-12 uppercase p-2">
          <li className="p-4 border-b border-b-gray-700"><Link to="/home" onClick={() => handleNavAndScroll("home")}>Home</Link></li>
          <li className="p-4 border-b border-b-gray-700"><Link to="/products" onClick={() => handleNavAndScroll("products")}>Products</Link></li>
          <li className="p-4 border-b border-b-gray-700"><Link to="/about" onClick={() => handleNavAndScroll("about")}>About</Link></li>
        </ul>
      </div>
    </div>
  );
